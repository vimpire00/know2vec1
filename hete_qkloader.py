...
class LearnwareDataset(Dataset):
    ...
    def __init__(self, args, stype, continuous_label=False, samples=None, heterogeneous=False):
        ...
        self.BKB_SPECIFIC_RANK2ID_SZY = {i: j for i, j in
                                         zip(self.BKB_SPECIFIC_RANK, range(len(self.BKB_SPECIFIC_RANK)))}
    ...
    def get_test_datarank(self, ):
        ...
        for i_dataset in cur_datasets:
            ...
            if self.stype == 'train' and self.args.fixed_gt_size_threshold != 0:
                cur_fixed_gt_samples = random.sample(cur_fixed_gt_samples,
                                                     min(len(cur_fixed_gt_samples), self.args.fixed_gt_size_threshold))
    ...
    def pad(self, ffea):
        ...
        if num_elements < 50:
            ...
            num_additional_tensors = 50 - num_elements
